...
public class Home extends MLandBase implements ObservableScrollView.Callbacks {
  ...
  private static final String mUSAFlagLink = "https://wiki.warthunder.com/images/9/9f/USA_flag.png";
  ...
  private static int fiftyFiveHundred = 5500;
  private static final float oneF = 1f;
  ...
  public void onCreate(Bundle savedInstanceState) {
     ...
     * "Germany", "https://www.tutorialspoint.com/python/", mGermanyFlagLink)); arrayList.add( new
     * SubjectData( "USSR", "https://www.tutorialspoint.com/javascript/", mUSSRFlagLink));
     * arrayList.add( new SubjectData( "Britain", "https://www.tutorialspoint.com/cprogramming/",
     * mBritainFlagLink)); arrayList.add( new SubjectData("Japan",
     * "https://www.tutorialspoint.com/java/", mJapanFlagLink)); arrayList.add( new
     * SubjectData("China", "https://www.tutorialspoint.com/python/", mChinaFlagLink));
     * arrayList.add( new SubjectData( "Italy", "https://www.tutorialspoint.com/javascript/",
     * mItalyFlagLink)); arrayList.add( new SubjectData( "France",
     * "https://www.tutorialspoint.com/cprogramming/", mFranceFlagLink)); arrayList.add( new
     * SubjectData( "Sweden", "https://www.tutorialspoint.com/javascript/", mSwedenFlagLink));
     * arrayList.add( new SubjectData( "Israel", "https://www.tutorialspoint.com/cprogramming/",
     * mIsraelFlagLink));
     *
     ...
     * onNavigationItemSelected(MenuItem item) { Intent intent; int itemId = item.getItemId(); if
     * (itemId == R.id.bb_usa) { intent = new Intent(getApplicationContext(), PlanesTest.class);
     * startActivity(intent); overridePendingTransition(0, 0); } return true; } }); *
     */
  ...
  private void initViews() {
    ...
    toolBarPlusPlaneTabsHeight = planeTabsHeight + toolBarHeight / six;
    ...
    /**
     * MaterialShapeDrawable navViewBackground = (MaterialShapeDrawable)
     * navigationView2.getBackground(); navViewBackground.setShapeAppearanceModel(
     * navViewBackground.getShapeAppearanceModel().toBuilder() .setTopRightCorner(16, radius)
     * .setBottomRightCorner(16, radius) .build()); *
     */
  ...
  public void onScrollChanged(int deltaX, int deltaY) {
    ...
    if (mPhotoHeightPixels != 0) {
       ...
       *
       * <p>// testing ViewCompat.setTranslationZ(draweeView, gapFillProgress * mMaxHeaderElevation
       * / 2); ViewCompat.setTranslationZ( mDetailsContainer, gapFillProgress * mMaxHeaderElevation
       * / 2); *
       */
